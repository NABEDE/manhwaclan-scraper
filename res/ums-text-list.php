<?php
   function manhwaclan_text_panel()
   {
        $theme = wp_get_theme();
...
<div class="wrap gs_popuptype_holder seo_pops">
    <h2><?php echo esc_html__("manhwaclan.com Manga Scraper", 'ultimate-manga-scraper');?></h2>
<div>
   <form id="myForm" method="post" action="<?php echo (manhwaclan_isSecure() ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";?>">
      <?php
         wp_nonce_field('manhwaclan_save_rules', '_umsr_nonce');
      ...
      <div>
            ...
            <div class="table-responsive">
               <table id="mainRules" class="responsive table cr_main_table">
                  <thead>
                     ...
                     <tbody>
                  <?php
                     echo manhwaclan_expand_rules_text($hu);
                     if(isset($_GET['manhwaclan_page']))
                     {
                         $current_page = $_GET['manhwaclan_page'];
                     }
                     else
                     {
                         $current_page = '';
                  ...
                  <td class="cr_short_td"><input type="text" name="manhwaclan_text_list[location][]" placeholder="https://manhwaclan.com/manga/..." value="" class="cr_width_full"/></td>
                  <td class="cr_comm_td"><input type="number" step="1" min="1" name="manhwaclan_text_list[schedule][]" max="8765812" class="cr_width_60" placeholder="Select the rule schedule interval" value="24"/></td>
                  <td class="cr_comm_td"><input type="number" step="1" min="0"<?php if (stristr($hu, '143.198.112.144') !== false){ echo ' max="3"';}?> name="manhwaclan_text_list[max][]" placeholder="Select the max # of generated chapters" value="1" class="cr_width_60"/></td>
                  <td class="cr_status"><select id="submit_status" name="manhwaclan_text_list[submit_status][]" class="cr_width_70">
                  ...
                  <td class="cr_author"><select id="post_author" name="manhwaclan_text_list[post_author][]" class="cr_width_auto cr_max_width_150">
                  <?php
                  ...
                  <span id="manhwaclan_close" class="codeclosefzr">&times;</span>
                  ...
                  </td><td><input type="number" min="1" name="manhwaclan_text_list[max_manga][]"<?php if (stristr($hu, '143.198.112.144') !== false){ echo ' max="1"';}?> value="1" placeholder="Maximum number of mangas to scrape" class="cr_width_full">
                  </div>
                  </td></tr><tr><td>
                  <div>
                  <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                  ...
                  <select class="cr_width_full" id="auto_categories" name="manhwaclan_text_list[auto_categories][]">
                  ...
                  <select class="cr_width_full" id="auto_tags" name="manhwaclan_text_list[auto_tags][]">
                  <option value="disabled" selected><?php echo esc_html__("Disabled", 'ultimate-manga-scraper');?></option>
                  <option value="genre"><?php echo esc_html__("Manga Tags", 'ultimate-manga-scraper');?></option>
                  </select> 
                  </div>
                  </td></tr>
                  <tr>
                     ...
                     <td>
                        <div>
                           <select id="use_phantom" name="manhwaclan_text_list[use_phantom][]" class="cr_width_full">
                            <option value="0" selected><?php echo esc_html__("WordPress", 'ultimate-manga-scraper');?></option>
                            <option value="1"><?php echo esc_html__("Use PhantomJS", 'ultimate-manga-scraper');?></option>          
                            <option value="2"><?php echo esc_html__("Use Puppeteer (Default)", 'ultimate-manga-scraper');?></option>
                            <option value="4"<?php if (!isset($manhwaclan_Main_Settings['headlessbrowserapi_key']) || trim($manhwaclan_Main_Settings['headlessbrowserapi_key']) == ''){echo ' title="' . esc_html__("This option is disabled. To enable it, add a HeadlessBrowserAPI Key in the plugin's 'Main Settings' menu.", 'ultimate-manga-scraper') . '" disabled';}?>><?php echo esc_html__("Puppeteer (HeadlessBrowserAPI)", 'ultimate-manga-scraper');if (!isset($manhwaclan_Main_Settings['headlessbrowserapi_key']) || trim($manhwaclan_Main_Settings['headlessbrowserapi_key']) == ''){echo esc_html__(' - to enable, add a HeadlessBrowserAPI key in the plugin\'s \'Main Settings\'', 'ultimate-manga-scraper');}?></option>
                            <option value="5"<?php if (!isset($manhwaclan_Main_Settings['headlessbrowserapi_key']) || trim($manhwaclan_Main_Settings['headlessbrowserapi_key']) == ''){echo ' title="' . esc_html__("This option is disabled. To enable it, add a HeadlessBrowserAPI Key in the plugin's 'Main Settings' menu.", 'ultimate-manga-scraper') . '" disabled';}?>><?php echo esc_html__("Tor (HeadlessBrowserAPI)", 'ultimate-manga-scraper');if (!isset($manhwaclan_Main_Settings['headlessbrowserapi_key']) || trim($manhwaclan_Main_Settings['headlessbrowserapi_key']) == ''){echo esc_html__(' - to enable, add a HeadlessBrowserAPI key in the plugin\'s \'Main Settings\'', 'ultimate-manga-scraper');}?></option>
                            <option value="6"<?php if (!isset($manhwaclan_Main_Settings['headlessbrowserapi_key']) || trim($manhwaclan_Main_Settings['headlessbrowserapi_key']) == ''){echo ' title="' . esc_html__("This option is disabled. To enable it, add a HeadlessBrowserAPI Key in the plugin's 'Main Settings' menu.", 'ultimate-manga-scraper') . '" disabled';}?>><?php echo esc_html__("PhantomJS (HeadlessBrowserAPI)", 'ultimate-manga-scraper');if (!isset($manhwaclan_Main_Settings['headlessbrowserapi_key']) || trim($manhwaclan_Main_Settings['headlessbrowserapi_key']) == ''){echo esc_html__(' - to enable, add a HeadlessBrowserAPI key in the plugin\'s \'Main Settings\'', 'ultimate-manga-scraper');}?></option>
                           </select>               
                        </div>
                     </td>
                  </tr>
                    ...
                    <td>
                    <input type="checkbox" id="enable_comments" name="manhwaclan_text_list[enable_comments][]" checked>
                    </div>
                    </td>
                    </tr>
                    <tr>
                    ...
                    <td>
                    <input type="checkbox" id="enable_pingback" name="manhwaclan_text_list[enable_pingback][]">
                    </div>
                    </td>
                    </tr>
                    <tr>
                    ...
                    <td>
                    <input type="checkbox" id="get_date" name="manhwaclan_text_list[get_date][]">
                    </div>
                    </td>
                    </tr>
                    <tr><td>
                  ...
                  <input type="text" name="manhwaclan_text_list[chapter_warning][]" value="" placeholder="Global Chapter Warning Message" class="cr_width_full">
                  </div>
                    </td></tr>
                    <tr>
                    <td colspan="2">
                    ...
                    <td>
                    <select class="cr_width_full" id="translate" name="manhwaclan_text_list[rule_translate][]" >
                    <?php
                        $i = 0;
                        ...
                        if(isset($manhwaclan_Main_Settings['deepl_auth']) && $manhwaclan_Main_Settings['deepl_auth'] != '')
                        {
                            $i = 0;
                        ...
                        if(isset($manhwaclan_Main_Settings['bing_auth']) && $manhwaclan_Main_Settings['bing_auth'] != '')
                        {
                            $i = 0;
                    ...
                    <td>
                    <input type="checkbox" id="no_translate_title" name="manhwaclan_text_list[no_translate_title][]">
                    </div>
                    </td>
                    </tr>
                  </table></div>
                  ...
                  <br/>
                  <h3 class="cr_inline">Madara Scraper</h3><span id="manhwaclan_ok" class="codeokfzr cr_inline">OK&nbsp;</span>
                  <br/><br/>
                  </div>
                  </div>
                  </div> 
                  ...
                  <td class="cr_comm_td"><input type="checkbox" name="manhwaclan_text_list[active][]" value="1" checked />
                  <input type="hidden" name="manhwaclan_text_list[last_run][]" value="1988-01-27 00:00:00"/></td>
         ...
         <hr/>
         <?php
            $next_url = (manhwaclan_isSecure() ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
            if(stristr($next_url, 'manhwaclan_page=') === false)
            {
                if(stristr($next_url, '?') === false)
                {
                    if($max_pages == 1)
                    {
                        $next_url .= '?manhwaclan_page=1';
                    }
                    else
                    {
                        $next_url .= '?manhwaclan_page=2';
                    }
                }
                else
                {
            ...
            else
            {
                ...
                if(is_numeric($curent_page))
                {
                    ...
                    $next_url = str_replace('manhwaclan_page=' . $curent_page, 'manhwaclan_page=' . $next_page, $next_url);
                }
                else
                {
                    if(stristr($next_url, '?') === false)
            ...
            $prev_url = (manhwaclan_isSecure() ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
            if(stristr($prev_url, 'manhwaclan_page=') === false)
            {
                if(stristr($prev_url, '?') === false)
                {
                    $prev_url .= '?manhwaclan_page=1';
                }
                else
                {
                    $prev_url .= '&manhwaclan_page=1';
            ...
            else
            {
                ...
                if(is_numeric($curent_page))
                {
                    ...
                    $prev_url = str_replace('manhwaclan_page=' . $curent_page, 'manhwaclan_page=' . $go_to, $prev_url);
                }
                else
                {
                    if(stristr($prev_url, '?') === false)
            ...
            $first_url = (manhwaclan_isSecure() ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
            if(stristr($first_url, 'manhwaclan_page=') === false)
            {
                if(stristr($first_url, '?') === false)
                {
                    $first_url .= '?manhwaclan_page=1';
                }
                else
                {
                    $first_url .= '&manhwaclan_page=1';
            ...
            else
            {
                ...
                if(is_numeric($curent_page))
                {
                    $first_url = str_replace('manhwaclan_page=' . $curent_page, 'manhwaclan_page=1', $first_url);
                }
                else
                {
                    if(stristr($first_url, '?') === false)
            ...
            if(isset($_GET['manhwaclan_page']) && is_numeric($_GET['manhwaclan_page']))
            {
                $this_page = $_GET["manhwaclan_page"];
            }
            else
            {
                $this_page = '1';
...
<?php
   ...
   if (isset($_POST['manhwaclan_text_list'])) {
       add_action('admin_init', 'manhwaclan_save_rules_text');
   }
   
   function manhwaclan_save_rules_text($data2)
   {
       $init_rules_per_page = get_option('manhwaclan_posts_per_page', 10);
       $rules_per_page = get_option('manhwaclan_posts_per_page', 10);
       if(isset($_POST['posts_per_page']))
       {
            update_option('manhwaclan_posts_per_page', $_POST['posts_per_page']);
       }
       check_admin_referer('manhwaclan_save_rules', '_umsr_nonce');
       
       $data2 = $_POST['manhwaclan_text_list'];
       $rules = get_option('manhwaclan_text_list', array());
       if($rules === false)
       {
           $rules = array();
       }
   ...
   function manhwaclan_expand_rules_text($hu)
   {
       $manhwaclan_Main_Settings = get_option('manhwaclan_Main_Settings', false);
    ...
    if(!is_array($rules))
    {
       ...
       if (!empty($rules)) {
           ...
           foreach ($post_list as $post) {
               $rule_id = get_post_meta($post, 'manhwaclan_parent_rule', true);
               if ($rule_id != '') {
                   $exp = explode('-', $rule_id);
           ...
           foreach ($rules as $request => $bundle[]) {
               ...
               $output .= '<tr>
                           ...
                           <td class="cr_short_td"><input type="text" step="1" name="manhwaclan_text_list[location][]" placeholder="https://manhwaclan.com/manga/..." value="' . esc_attr($manga_name) . '" class="cr_width_full" required/></td>
                           <td class="cr_comm_td"><input type="number" step="1" min="1" placeholder="# h" name="manhwaclan_text_list[schedule][]" max="8765812" value="' . esc_attr($schedule) . '" class="cr_width_60" required></td>
                           <td class="cr_comm_td"><input type="number" step="1" min="0" placeholder="# max" name="manhwaclan_text_list[max][]"';if (stristr($hu, '143.198.112.144') !== false){ $output .= ' max="3"';} $output .= ' value="' . esc_attr($max) . '"  class="cr_width_60" required></td>
                           <td class="cr_status"><select id="submit_status" name="manhwaclan_text_list[submit_status][]" class="cr_width_70">
     ...
     <div class="codemodalfzr-content">
       <div class="codemodalfzr-header">
         <span id="manhwaclan_close' . esc_html($cont) . '" class="codeclosefzr">&times;</span>
       ...
       <div class="table-responsive">
         <table class="responsive table cr_main_table_nowr">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input class="cr_width_full" type="number" min="1" name="manhwaclan_text_list[max_manga][]"';if (stristr($hu, '143.198.112.144') !== false){ $output .= ' max="1"';} $output .= ' value="' . esc_attr($max_manga) . '" placeholder="Maximum number of mangas to scrape" >
           </div>
           </td></tr><tr><td>
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
               ...
               $output .= '>' . esc_html__("Manga Tags", 'ultimate-manga-scraper') . '</option>
                       </select>     
           </div>
           </td></tr>
           <tr><td>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="enable_comments" name="manhwaclan_text_list[enable_comments][]"';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input class="cr_width_full" type="text" name="manhwaclan_text_list[chapter_warning][]" value="' . esc_attr($chapter_warning) . '" placeholder="Global Chapter Warning Message" >
       ...
       <div class="codemodalfzr-footer">
         <br/>
         <h3 class="cr_inline">Madara Scraper</h3><span id="manhwaclan_ok' . esc_html($cont) . '" class="codeokfzr cr_inline">OK&nbsp;</span>
         <br/><br/>
       </div>
     </div>
                           ...
                           <td class="cr_comm_td"><input type="checkbox" name="manhwaclan_text_list[active][]" class="activateDeactivateClass" value="1"';
               if (isset($active) && $active === '1') {
                   $output .= ' checked';
               }
               $output .= '/>
                           <input type="hidden" name="manhwaclan_text_list[last_run][]" value="' . esc_attr($last_run) . '"/></td>
                           <td class="cr_comm_td"><div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
               ...
               if ($generated_posts != 0) {
                   $output .= '<a href="' . get_admin_url() . 'edit.php?coderevolution_post_source=manhwaclan_1_' . esc_html($cont) . '&post_type=wp-manga" target="_blank">' . esc_html__('View Generated Manga', 'ultimate-manga-scraper') . '</a><br/>';
               }
               ...
               if (!empty($running)) {
                   ...
                   {
                       $f = fopen(get_temp_dir() . 'manhwaclan_1_' . $cont, 'w');
                       if($f !== false)
                       {
