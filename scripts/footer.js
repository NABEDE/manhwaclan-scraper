...
function runNowManual(number, typeId, automate)
{
    if (automate != 0 || confirm("Are you sure you want to run this rule now?") == true) {
        ...
        {
            var data = {
                action: 'manhwaclan_run_my_action',
                id: number,
                type: typeId
            };
        }
...
function manhwaclan_sleepFor(sleepDuration){
    var now = new Date().getTime();
    while(new Date().getTime() < now + sleepDuration){ /* Do nothing */ }
}
function manhwaclan_wait(ms){
...
function actionsChangedManual(ruleId, selectedValue, typeId)
{
    ...
    else
    {
		...
		jQuery(document).ready(function() {
			jQuery('.manhwaclan_image_button').on('click', function(){
...
var span = document.getElementById("manhwaclan_close");
var ok = document.getElementById("manhwaclan_ok");
if(btn != null)
{
...
function createAdmin(i) {
    ...
    spans = document.getElementById("manhwaclan_close" + i);
    oks = document.getElementById("manhwaclan_ok" + i);
